...
/**
*  Implement custom Java Libraries
*/ 
// Theme JavaScript
wp_enqueue_script( 'agency-theme-javaScript', get_template_directory_uri() . '/inc/assets/js/agency.js', $deps, $ver, 'true');

// Adding blowfish.js at home page
function add_blowfish_home() {
    if(is_front_page()){ 
    	wp_enqueue_script( 'blowfish-javaScript', get_template_directory_uri() . '/inc/assets/js/blowfish.js', $deps, $ver, 'true');   
    }
}
add_action( 'wp_enqueue_scripts', 'add_blowfish_home' );

// Contact Form JavaScript
wp_enqueue_script( 'jq-bootstrap-validation', get_template_directory_uri() . '/inc/assets/js/jqBootstrapValidation.js', $deps, $ver, 'true');
wp_enqueue_script( 'contact-me', get_template_directory_uri() . '/inc/assets/js/contact_me.js', $deps, $ver, 'true');

/**
*  Allow SPAN tags in WP Editor
*/ 
function override_mce_options($initArray) 
{
 ...
 /********   Disable Website field in Form Comment  ********/
